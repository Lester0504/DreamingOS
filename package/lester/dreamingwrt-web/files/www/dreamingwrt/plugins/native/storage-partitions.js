...
export function mount(context = {}) {
  ...
  function tableMarkup(disk) {
    ...
    return `<section class="storage-partitions-table dwrt-kit-table-wrap dwrt-kit-datatable-wrap dwrt-kit-glass-surface" data-dwrt-component="table"><div class="dwrt-kit-table-toolbar"><div class="dwrt-kit-table-title"><strong>分区信息</strong><span>设备、容量、扇区、文件系统与挂载状态</span></div><span class="dwrt-kit-table-count">${disk.partitions.length} 个</span></div><div class="dwrt-kit-table-scroll"><table class="dwrt-kit-table dwrt-kit-datatable"><thead><tr><th>名称 / 设备</th><th>容量 / 用量</th><th>起始 / 结束扇区</th><th>文件系统 / 标识</th><th>挂载点</th><th>状态</th><th>操作</th></tr></thead><tbody>${rows || '<tr><td colspan="7" class="dwrt-kit-table-empty">后端没有返回这个磁盘的分区</td></tr>'}</tbody></table></div></section>`;
  }
