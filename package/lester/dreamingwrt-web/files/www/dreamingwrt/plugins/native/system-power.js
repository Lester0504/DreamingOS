export function mount(context = {}) {
  ...
  function schedulesMarkup() {
    ...
    return `<main class="system-power-schedules"><section class="system-power-table-card dwrt-kit-table-wrap dwrt-kit-datatable-wrap dwrt-kit-glass-surface"><div class="dwrt-kit-table-toolbar"><div class="dwrt-kit-table-title"><strong>重启计划</strong></div><span class="dwrt-kit-table-count">${state.schedulesKnown ? `${state.schedules.length} 条` : '--'}</span></div><div class="dwrt-kit-table-scroll"><table class="dwrt-kit-table dwrt-kit-datatable system-power-table"><thead><tr><th class="system-power-check-cell"><input type="checkbox" aria-label="全选计划"></th><th>名称</th><th>计划事件</th><th>周期</th><th>日期</th><th>时间</th><th>备注</th><th>状态</th><th>操作</th></tr></thead><tbody>${body}</tbody></table></div></section></main>`;
  }
