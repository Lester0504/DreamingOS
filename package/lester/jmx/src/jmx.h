...
#ifndef __JMX_H__
#define __JMX_H__
#define JMX_VERSION "5.1.7"
#define MAX_JMX_NL_MSG_LEN 1024
...
/* /proc/dreamingwrt/jmx/ directory entries */
extern struct proc_dir_entry *jmx_proc_root;  /* /proc/dreamingwrt/jmx */

#define JMX_PROC_ROOT_NAME "dreamingwrt"
#define JMX_PROC_JMX_NAME "jmx"
...
extern u_int32_t jmx_log_level;
...
#define MAX_ACTIVE_APP_LIST_SIZE 64
#define MAX_ACTIVE_HOST_LIST_SIZE 64
...
#define LOG(level, fmt, ...) do { \
	if (((level) == 3 && jmx_debug_at_least(3)) || \
	    ((level) != 3 && (level) <= af_log_lvl)) { \
