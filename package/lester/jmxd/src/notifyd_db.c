...
static const struct notifyd_event_definition notifyd_event_definitions[] = {
    { "SYSTEM_RESOURCE_THRESHOLD", "SYSTEM", "System Resource Threshold", "dreamingwrt.logd", "", "", "warning", 1 },
    ...
    { "WAN_EVENT", "INTERNET_AND_WAN", "WAN Event", "dreamingwrt.logd", "", "", "notice", 1 },
    { "PPPOE_EVENT", "INTERNET_AND_WAN", "PPPoE Event", "dreamingwrt.logd", "", "", "notice", 1 },
    { "PORT_LINK_DOWN", "INTERNET_AND_WAN", "Port Link Down", "dreamingwrt.logd", "PORT_LINK_UP", "", "warning", 1 },
    { "PORT_LINK_UP", "INTERNET_AND_WAN", "Port Link Up", "dreamingwrt.logd", "PORT_LINK_DOWN", "", "notice", 1 },
    { "PORT_EVENT", "INTERNET_AND_WAN", "Port Event", "dreamingwrt.logd", "", "", "notice", 1 },
    { "CLIENT_CONNECTED_WIRED", "CLIENT_DEVICES", "Wired Client Connected", "dreamingwrt.logd", "CLIENT_DISCONNECTED", "", "notice", 1 },
    { "CLIENT_DISCONNECTED", "CLIENT_DEVICES", "Client Disconnected", "dreamingwrt.logd", "CLIENT_CONNECTED_WIRED", "", "notice", 1 },
    { "DHCP_EVENT", "CLIENT_DEVICES", "DHCP Event", "dreamingwrt.logd", "", "", "notice", 1 },
    { "ADMIN_AUTH_EVENT", "ADMIN", "Admin Authentication Event", "dreamingwrt.logd", "", "", "warning", 1 },

    { "WAN_DOWN", "INTERNET_AND_WAN", "Internet Down", "", "WAN_RESTORED", "confirmed_wan_reachability_producer_pending", "warning", 0 },
    { "WAN_RESTORED", "INTERNET_AND_WAN", "Internet Restored", "", "WAN_DOWN", "confirmed_wan_reachability_producer_pending", "notice", 0 },
    { "WAN_FAILOVER_ACTIVE", "INTERNET_AND_WAN", "WAN Failover Active", "", "WAN_FAILBACK", "multi_wan_transition_producer_pending", "warning", 0 },
    { "WAN_FAILBACK", "INTERNET_AND_WAN", "WAN Failback", "", "WAN_FAILOVER_ACTIVE", "multi_wan_transition_producer_pending", "notice", 0 },
    { "WAN_FLAPPING", "INTERNET_AND_WAN", "WAN Flapping", "", "", "wan_transition_window_aggregation_pending", "warning", 0 },
    ...
    { "DHCP_POOL_EXHAUSTED", "CLIENT_DEVICES", "DHCP Pool Exhausted", "", "", "dhcp_pool_capacity_producer_pending", "critical", 0 },
                                            ...
                                            const char **reason)
{
    ...
    if (!explicit_present &&
        ...
        explicit_value = notifyd_json_bool_override(detail, "browser_interrupt",
                                                    &explicit_present);
    if (explicit_present) {
        if (explicit_value && rank < notifyd_severity_rank("warning"))
            explicit_value = 0;
        if (reason)
            *reason = explicit_value ? "producer_explicit" :
                      (rank < notifyd_severity_rank("warning") ?
                       "producer_explicit_below_warning" : "producer_suppressed");
...
struct json_object *notifyd_outbox_list(struct json_object *body)
{
    ...
    json_object_object_add(resp, "interrupt_policy", json_object_new_string(
        "explicit_or_confirmed_connectivity_loss_or_critical_resource_or_confirmed_security"));
    return resp;
}
